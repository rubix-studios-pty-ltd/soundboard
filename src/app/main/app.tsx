...
import { FavoriteGrid } from '@/components/grid/favorites'
import { AudioGrid } from '@/components/grid/main'
    ...
    <div className="flex h-screen flex-col overflow-hidden" style={themeStyles}>
      ...
      <main className="flex-1 overflow-y-auto p-1">
        ...
        <div className="flex flex-wrap items-start justify-around gap-1">
          {showSoundGrid && <AudioGrid type="sound" containerId="container1" />}
          {showSoundGrid && showMusicGrid && <Separator className="my-1" />}
          {showMusicGrid && <AudioGrid type="music" containerId="container2" />}
        </div>
      </main>
      <Footer />
    </div>
