...
class SettingsManager {
  ...
  constructor() {
    this.multiSoundSwitch = document.getElementById(
      "multiSoundSwitch"
    ) as HTMLInputElement
    this.repeatSoundSwitch = document.getElementById(
      "repeatSoundSwitch"
    ) as HTMLInputElement
    this.alwaysOnTopSwitch = document.getElementById(
      "alwaysOnTopSwitch"
    ) as HTMLInputElement
    ...
    this.speakerUnmuted = document.getElementById(
      "speakerUnmuted"
    ) as HTMLElement
